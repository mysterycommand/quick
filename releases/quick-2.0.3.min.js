...
getRealHeight:function(){return D},getRealWidth:function(){return C},load:function(){return localStorage.saveData&&JSON.parse(localStorage.saveData)},mute:function(){q.mute()},paint:function(a,b){z[b||0].add(a)},play:function(a){q.play(a)},playTheme:function(a){q.playTheme(a)},random:function(a){return Math.floor(Math.random()*(a+1))},save:function(a){localStorage.saveData=JSON.stringify(a)},setAutoScale:function(a){c=void 0==a||a},setFrameTime:function(a){h=a||30},setKeepAspect:function(a){F=a||
!1},setName:function(a){u=a;document.title=u},setNumberOfLayers:function(a){w=a},stopTheme:function(){q.stopTheme()}};return E}(),K=function(){function b(a,b,d){var c=document.createElement("canvas");c.width=a.width;c.height=a.height;var f=c.getContext("2d");f.translate(b?c.width:0,d?c.height:0);f.scale(b?-1:1,d?-1:1);f.drawImage(a,0,0);return c}return{flip:function(a){return b(a,!1,!0)},mirror:function(a){return b(a,!0,!1)},rotate:function(a,b){if(0==b%360)return a;var d=b*Math.PI/180,c=document.createElement("canvas");
90==b||270==b?(c.width=a.height,c.height=a.width):(c.width=a.width,c.height=a.height);var f=c.getContext("2d");f.translate(c.width/2,c.height/2);f.rotate(d);f.drawImage(a,-a.width/2,-a.height/2);return c}}}(),w=function(){function b(a){function b(a){a.preventDefault();d.buffer=!0}var d=this;this.buffer=!1;this.position=new n;addEventListener("mousedown",b,!1);addEventListener("mouseup",function(a){a.preventDefault();d.buffer=!1},!1);addEventListener("mousemove",function(a){a.preventDefault();d.updateCoordinates(a)},
!1);a&&b(a)}b.prototype.getCommand=function(){return this.buffer};b.prototype.getX=function(){return this.position.getX()};b.prototype.getY=function(){return this.position.getY()};b.prototype.updateCoordinates=function(a){this.position.setPosition(a.x||a.clientX,a.y||a.clientY)};return b}(),L=function(){function b(a){function b(a){a.preventDefault();d.buffer=!0;d.updateCoordinates(a)}var d=this;this.buffer=!1;this.position=new n;addEventListener("touchstart",b,!1);addEventListener("touchend",function(a){a.preventDefault();
...
a||0}var a={};a[12]=e.UP;a[13]=e.DOWN;a[14]=e.LEFT;a[15]=e.RIGHT;a[0]=e.A;a[1]=e.B;a[2]=e.X;a[3]=e.Y;a[9]=e.START;a[8]=e.SELECT;b.prototype.getCommands=function(){var b={};-.5>t.getGamepadAxes(this.id)[1]?b[e.UP]=!0:.5<t.getGamepadAxes(this.id)[1]&&(b[e.DOWN]=!0);-.5>t.getGamepadAxes(this.id)[0]?b[e.LEFT]=!0:.5<t.getGamepadAxes(this.id)[0]&&(b[e.RIGHT]=!0);var d=t.getGamepadButtons(this.id),c;for(c in a)d[c]&&d[c].pressed&&(b[a[c]]=!0);return b};return b}(),t=function(){function b(){this.controllers=
[];this.controllerQueue=[];this.controllerRequestQueue=[];this.pointers=[];this.pointerQueue=[];this.pointerRequestQueue=[];this.gamepads=0;this.waitKeyboard();this.waitMouse();this.waitTouch()}function a(){return navigator.getGamepads?navigator.getGamepads():[]}b.getGamepadAxes=function(b){return a()[b]?a()[b].axes:[]};b.getGamepadButtons=function(b){return(b=a()[b])&&b.buttons||[]};b.prototype.addController=function(a){this.controllerQueue.push(a);this.checkControllerQueues()};b.prototype.addPointer=
...
a,!1)};return b}(),O=function(){function b(b){function c(b){l[b.keyCode]||b.preventDefault();f.buffer[a[b.keyCode]]=!0}var f=this;this.buffer={};addEventListener("keydown",c,!1);addEventListener("keyup",function(b){f.buffer[a[b.keyCode]]=!1},!1);c(b)}var a={};a[38]=e.UP;a[69]=e.UP;a[73]=e.UP;a[40]=e.DOWN;a[68]=e.DOWN;a[75]=e.DOWN;a[37]=e.LEFT;a[83]=e.LEFT;a[74]=e.LEFT;a[39]=e.RIGHT;a[70]=e.RIGHT;a[76]=e.RIGHT;a[32]=e.A;a[18]=e.B;a[17]=e.X;a[16]=e.Y;a[13]=e.START;a[27]=e.SELECT;var l=[];l[116]=!0;
l[122]=!0;l[123]=!0;b.prototype.getCommands=function(){var a={},b;for(b in this.buffer)this.buffer[b]&&(a[b]=!0);return a};return b}(),J=function(){function b(){this.elements=[]}b.prototype.add=function(a){this.elements.push(a)};b.prototype.render=function(a){for(var b=0;b<this.elements.length;++b)this.elements[b].render(a);this.elements.length=0};return b}(),P=function(){function b(){this.delegate=null;this.gameObjects=[];this.nextObjects=[];this.expiration=-1;this.isExpired=!1;this.tick=-1;this.transition=
null}b.prototype.add=function(a){a.setScene(this);a.init();this.nextObjects.push(a);a.move(-1*a.getSpeedX(),-1*a.getSpeedY())};b.prototype.build=function(a,b,d,c){b=b||function(a){return new G(a)};for(var f=0;f<a.length;++f)for(var e=a[f],h=0;h<e.length;++h){var g=a[f][h];if(g){var g=b(g),k=d?d:g.getWidth(),p=c?c:g.getHeight();g.setTop(f*p);g.setLeft(h*k);this.add(g)}}};b.prototype.expire=function(){this.isExpired=!0};b.prototype.sync=function(){if(this.isExpired)return!0;for(var a=[],b=[],d=0;d<
...
a||!0};b.prototype.setRight=function(a){this.isRight=a||!0};b.prototype.setTop=function(a){this.isTop=a||!0};return b}(),u=function(){function b(a,b){this.duration=b||0;this.image=a||new Image}b.prototype.getDuration=function(){return this.duration};b.prototype.getHeight=function(){return this.image.height};b.prototype.getImage=function(){return this.image};b.prototype.getWidth=function(){return this.image.width};return b}(),H=function(){function b(a){this.setFrames(a)}b.prototype.getHeight=function(){return this.frame.getHeight()};
...
this.getImage(),d=Math.floor(this.getX()),c=Math.floor(this.getY());a.drawImage(b,d,c,this.getWidth(),this.getHeight())}};b.prototype.setAnimation=function(a){this.animation!=a&&(this.animation=a,this.animation.setFrameIndex(0),this.setHeight(this.animation.getHeight()),this.setWidth(this.animation.getWidth()))};b.prototype.setBoundary=function(a){this.boundary=a||g.getBoundary()};b.prototype.setDelegate=function(a){this.delegate=a};b.prototype.setImage=function(a){this.setAnimation(new H([new u(a)]))};
...
b&&(b=h.height))}this.setWidth(d);this.setHeight(e+b)};b.prototype.render=function(a){this.parse(a)};b.prototype.setString=function(a){this.string=a;this.parse()};return b}(),G=function(){function b(a){k.call(this);this.setImageId(a)}b.prototype=Object.create(k.prototype);return b}(),S=function(){function b(){k.call(this);this.setColor("Black");this.setHeight(g.getCanvasHeight());this.increase=g.getCanvasWidth()/32}b.prototype=Object.create(k.prototype);b.prototype.sync=function(){if(this.getWidth()>
g.getCanvasWidth())return!0;this.increaseWidth(this.increase);g.paint(this);return k.prototype.sync.call(this)};return b}();window.com||(window.com={});window.com.dgsprb||(window.com.dgsprb={});window.com.dgsprb.quick={Animation:H,BaseTile:G,BaseTransition:S,CommandEnum:e,Controller:x,Frame:u,GameObject:k,ImageFactory:K,Mouse:w,Point:n,Quick:g,Rect:v,Scene:P,Sprite:m,Text:R}})();
